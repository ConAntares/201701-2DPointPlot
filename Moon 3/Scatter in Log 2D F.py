...
plt.yticks([0.589, 0.590, 0.591, 0.592, 0.593, 0.594, 0.595, 0.596, 0.597, 0.598, 0.599, 0.600, 0.601], \
    [r'$0.589$', r'$0.590$', r'$0.591$', r'$0.592$', r'$0.593$', r'$0.594$', r'$0.595$', r'$0.596$', r'$0.597$', r'$0.598$', r'$0.599$', r'$0.600$', r'$0.601$'], fontsize=16)
plt.xlabel(r'$N$', family='serif', fontsize=16)
plt.ylabel(r'$f^{\prime\prime}(0)$', family='serif', fontsize=16)
plt.grid()

plt.savefig('F\'\'(0).eps', dpi=1024)
plt.savefig('F\'\'(0).png', dpi=512)
plt.show()
